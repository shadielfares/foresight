...
if __name__ == "__main__":
    """
    Project Foresight is AI + Life Coaching.
    
    Generalized Advice = Garbage.
        Foresight fixes that :)
    """
    ...
    # Include as many habits as you'd like to check similarly
    print(rank_relatability(people, blocks, ["Coding", "Making Money", "Paragliding"]))